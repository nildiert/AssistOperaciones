...
<div class="d-flex mt-3 ">
        ...
        <div class="col-7 ">
            ...
            <div class="input-group">
                ...
                {{Form::text('busqueda',null,['class'=>'form-control pl-2 w-50', 'aria-label'=>'Text input with segmented dropdown button', 'placeholder'=>'Valor a buscar', 'required'])}}
        ...
        <div class="col-5 d-flex justify-content-end clearfix">
                <a class="btn btn-outline-secondary  mb-3 mr-1 "  href="{{URL::previous()}}">Volver</a>
