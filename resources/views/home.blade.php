        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <div class="row"><!--Inicio de la clase Row-->
                        ...
                        <div class="dropdown"><!--Inicio  Div CARPERS-->
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                cargpers
                            </button>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{route('cargpers.index')}}">Mostrar</a>
                                <a class="dropdown-item" href="{{route('cargpers.create')}}">Agregar</a>
                            </div>
                        </div><!--Fin  Div Recursos Fisicos-->
